...
const SponsoredComponents = () => {
  return (
    <div className="hidden sm:block bg-white py-10 px-5 mb-12 cursor-pointer rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 items-center justify-items-center">
          ...
          <div className="flex items-center justify-center p-4 hover:opacity-80 transition-opacity">
            <img
              src="https://cdn.shopify.com/s/files/1/0558/6413/1764/files/LG_Logo_Design_History_Evolution_10_1024x1024.jpg?v=1692865761"
              alt="LG"
              className="w-32 h-20 object-contain"
            />
          </div>
...
export default SponsoredComponents;
